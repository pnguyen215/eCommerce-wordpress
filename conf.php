...
define('WP_TIMEZONE', $_ENV['WP_TIMEZONE'] ?? "");
define('WP_ENABLED_DEBUG_MODE', $_ENV['WP_ENABLED_DEBUG_MODE'] ?? "");
define('WP_DEBUG_LOG_FILE', $_ENV['WP_DEBUG_LOG_FILE']);
define('WP_ENABLED_DEBUG_DISPLAY', $_ENV['WP_ENABLED_DEBUG_DISPLAY']);
...
define('ENABLED_USING_WOO_PRODUCT_ID_REPLACED', $_ENV['ENABLED_USING_WOO_PRODUCT_ID_REPLACED']);
define('REDIRECT_LINK_ORDER_COMPLETED', $_ENV['REDIRECT_LINK_ORDER_COMPLETED']);
define('REDIRECT_LINK_ORDER_FAILURE', $_ENV['REDIRECT_LINK_ORDER_FAILURE']);
...
define('VIRTUAL_SANDBOX_TRACKER_ID', $_ENV['VIRTUAL_SANDBOX_TRACKER_ID'] ?? 0);
?>